            ...
            <div class="row">
                ...
                <div class="content col-md-12">
                    ...
                    <table class="table table-striped table-bordered">
                        ...
                        <tbody>
                            <tr ng-repeat="drug_detail in drugDetails| filter: searchBox | orderBy: 'dd_qty'" required>
                                <td>{{$index + 1}}</td>
...
<!--                                            <label for="dd_group_name">Group Name :</label>
                                            <input ng-bind="newDrugDetail.dd_brand_name" type="text" class="form-control" id="dd_group_name" >-->
...
<!--                                            <label for="dd_unit">Unit :</label>
                                            ...
                                            <input ng-model="newDrugDetail.dd_qty" type="text" class="form-control" id="dd_qty">

                                            <label for="dd_unit_buy">U.Buy Cost :</label>
                                            <input ng-model="newDrugDetail.dd_unit_buy" type="text" class="form-control" id="dd_unit_buy">

                                            <label for="dd_unit_sale">U.Sale Cost :</label>
                                            <input ng-model="newDrugDetail.dd_unit_sale" type="text" class="form-control" id="dd_unit_sale">

                                            <!--                                            <label for="dd_total_buy">T.Buy Cost :</label>
                                                                                        <input ng-model="newDrugDetail.dd_total_buy" type="text" class="form-control" id="dd_total_buy">
                                                                                        
                                                                                        <label for="dd_total_sale">T.Sale Cost :</label>
                                                                                        <input ng-model="newDrugDetail.dd_total_sale" type="text" class="form-control" id="dd_total_sale">-->
                                        </div>
                    ...
                    <div id="myModalBuy" class="modal fade" role="dialog">
                        <div class="modal-dialog">
                            ...
                            <div class="modal-content">
                                <div class="modal-header">
                                    <button type="button" class="close" data-dismiss="modal">&times;</button>
                                    <h4 class="modal-title">Buy DrugDetail</h4>
                                </div>
                                <div class="modal-body">
                                    <form>
                                        ...
                                        <button ng-click="buyDrug()" data-dismiss="modal" type="submit" class="btn btn-success">BUY</button>
                                    </form> 
                                </div>
                                <div class="modal-footer">
                                    <button type="button" class="btn btn-default" data-dismiss="modal">Close</button>
                    ...
                    <div id="myModalSale" class="modal fade" role="dialog">
                        <div class="modal-dialog">
                            ...
                            <div class="modal-content">
                                <div class="modal-header">
                                    <button type="button" class="close" data-dismiss="modal">&times;</button>
                                    <h4 class="modal-title">Sale DrugDetail</h4>
                                </div>
                                <div class="modal-body">
                                    <form>
                                        <div class="form-group">
                    ...
                    <div id="myModalDelete" class="modal fade" role="dialog">
                        <div class="modal-dialog">
                            ...
                            <div class="modal-content">
                                <div class="modal-header">
                                    <button type="button" class="close" data-dismiss="modal">&times;</button>
                                    <h4 class="modal-title">Delete DrugDetail</h4>
                                </div>
                                <div class="modal-body">
